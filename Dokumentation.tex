...
\noindent\textsc{T\_enth\_H}(\uline{\dashuline{T\_ID}, \dashuline{H\_Name}}, wie\_oft)

\noindent\textsc{Hashtag\_Paare}(\uline{ID}, Anzahl\_global)

\noindent\textsc{H\_bilden\_HP}(\uline{\dashuline{H\_Name}, \dashuline{HP\_ID}})

\noindent\textsc{T\_enth\_HP}(\uline{\dashuline{T\_ID}, \dashuline{HP\_ID}}, wie\_oft)
